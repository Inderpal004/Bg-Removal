    ...
    return (
        <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
            ...
            <div >
                ...
                <p className='my-6 text-[15px] text-gray-500'>By uploading an image or URL you agree to our Terms of Service. <br className='max-sm:hidden'/> To learn more about how remove.bg handles your personal data, check our Privacy Policy.</p>
                <div>
